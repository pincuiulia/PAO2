...
public class UserRepositoryService {
    ...
    //din cate stiu, aici ne conectam la baza de date cu astea
    ...
    public Organizer getOrganizerByUsernameAndPassword(String username, String password){
    ...
    public User getUser(String typeOfPerson, String username, String password) {
        User user = null;
        switch (typeOfPerson) {
            case CLIENT:
    ...
    public void deleteUser(String typeOfUser, String username, String password){
